...
namespace ArenaUnity.Schemas
{
    ...
    {
        [JsonIgnore]
        public readonly string attributeName = "armarker";
        ...
        private static bool defBuildable = false;
        [JsonProperty(PropertyName = "buildable")]
        [Tooltip("Whether tag has 'dynamic' toggled on click. Used to position a tag, then lock into position.")]
        public bool Buildable = defBuildable;
        public bool ShouldSerializeBuildable()
        {
        ...
        [Tooltip("The marker type, technology-based.")]
