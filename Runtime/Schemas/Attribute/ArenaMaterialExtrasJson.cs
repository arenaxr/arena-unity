...
namespace ArenaUnity.Schemas
{
    ...
    {
        [JsonIgnore]
        public readonly string attributeName = "material-extras";
        ...
        private static ColorSpaceType defColorSpace = ColorSpaceType.SrGBColorSpace;
        [JsonConverter(typeof(StringEnumConverter))]
        [JsonProperty(PropertyName = "colorSpace")]
        [Tooltip("The material colorspace.")]
        public ColorSpaceType ColorSpace = defColorSpace;
        public bool ShouldSerializeColorSpace()
        {
        ...
        private static float defGltfOpacity = 1f;
        [JsonProperty(PropertyName = "gltfOpacity")]
        [Tooltip("Opacity value to apply to the model. 1 is fully opaque, 0 is fully transparent.")]
        public float GltfOpacity = defGltfOpacity;
        public bool ShouldSerializeGltfOpacity()
        {
            return true; // required in json schema
        }
