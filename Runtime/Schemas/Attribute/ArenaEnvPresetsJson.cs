...
namespace ArenaUnity.Schemas
{
    ...
    {
        [JsonIgnore]
        public readonly string attributeName = "env-presets";

        // env-presets member-fields

        private static bool defActive = true;
        [JsonProperty(PropertyName = "active")]
        [Tooltip("Shows or hides the environment presets component. Use this instead of using the visible attribute.")]
