...
// Modified from: https://github.com/mattatz/unity-mesh-builder/blob/master/Assets/Packages/MeshBuilder/Scripts/Builders/FrustumBuilder.cs

using UnityEngine;

namespace ArenaUnity
{
    public class FrustumBuilder
    {
