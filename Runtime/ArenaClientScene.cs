...
namespace ArenaUnity
{
    ...
    public partial class ArenaClientScene : ArenaMqttClient
    {
        ...
        static readonly string[] msgUriTags = { "url", "src", "obj", "mtl", "overrideSrc", "detailedUrl", "headModelPath", "texture", "navMesh", "normalMap", "ambientOcclusionMap", "displacementMap", "metalnessMap", "roughnessMap", "bumpMap", "sphericalEnvMap", "img", "video_path" };
